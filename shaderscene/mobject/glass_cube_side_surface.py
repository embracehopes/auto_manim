...
class GlassCubeSideSquare(ShaderSurface):
    """显示复杂3D玻璃立方体侧面效果的正方形面"""
    shader_folder: str = str(Path(Path(__file__).parent.parent / "glass_cube_side_shader"))
    
    def __init__(self, **kwargs):
        """
        创建一个显示复杂3D玻璃立方体侧面效果的正方形面
        使用侧视角度的shader
        """
